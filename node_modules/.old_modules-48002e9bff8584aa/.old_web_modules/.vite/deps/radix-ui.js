import {
  require_react_dom
} from "./chunk-LNCIBHNA.js";
import {
  composeRefs,
  useComposedRefs
} from "./chunk-7NPTXV4T.js";
import {
  require_jsx_runtime
} from "./chunk-BX6LCJEB.js";
import {
  require_react
} from "./chunk-ECVQJDVO.js";
import {
  __commonJS,
  __export,
  __toESM
  ...
  "../../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      function useSyncExternalStore$2(subscribe2, getSnapshot) {
        didWarnOld18Alpha || void 0 === React143.startTransition || (didWarnOld18Alpha = true, console.error(
      ...
      var React143 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React143.useState, useEffect40 = React143.useEffect, useLayoutEffect6 = React143.useLayoutEffect, useDebugValue = React143.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
      exports.useSyncExternalStore = void 0 !== React143.useSyncExternalStore ? React143.useSyncExternalStore : shim;
...
var Primitive = NODES.reduce((primitive, node) => {
  const Slot44 = createSlot(`Primitive.${node}`);
  const Node2 = React2.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
...
var Primitive2 = NODES2.reduce((primitive, node) => {
  const Slot44 = createSlot3(`Primitive.${node}`);
...
var Primitive3 = NODES3.reduce((primitive, node) => {
  const Slot44 = createSlot4(`Primitive.${node}`);
...
var CollapsibleContent = React17.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => (0, import_jsx_runtime13.jsx)(CollapsibleContentImpl, { ...contentProps, ref: forwardedRef, present }) });
  }
);
...
var Accordion = import_react3.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Collection.Provider, { scope: props.__scopeAccordion, children: type === "multiple" ? (0, import_jsx_runtime15.jsx)(AccordionImplMultiple, { ...multipleProps, ref: forwardedRef }) : (0, import_jsx_runtime15.jsx)(AccordionImplSingle, { ...singleProps, ref: forwardedRef }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(
      AccordionValueProvider,
      {
        ...
        children: (0, import_jsx_runtime15.jsx)(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible, children: (0, import_jsx_runtime15.jsx)(AccordionImpl, { ...accordionSingleProps, ref: forwardedRef }) })
      }
    );
  }
);
var AccordionImplMultiple = import_react3.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime15.jsx)(
    AccordionValueProvider,
    {
      ...
      children: (0, import_jsx_runtime15.jsx)(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible: true, children: (0, import_jsx_runtime15.jsx)(AccordionImpl, { ...accordionMultipleProps, ref: forwardedRef }) })
    }
  );
});
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(
      AccordionImplProvider,
      {
        ...
        direction: dir,
        orientation,
        children: (0, import_jsx_runtime15.jsx)(Collection.Slot, { scope: __scopeAccordion, children: (0, import_jsx_runtime15.jsx)(
          Primitive2.div,
          {
            ...accordionProps,
...
var AccordionTrigger = import_react3.default.forwardRef(
  (props, forwardedRef) => {
    ...
    const collapsibleScope = useCollapsibleScope(__scopeAccordion);
    return (0, import_jsx_runtime15.jsx)(Collection.ItemSlot, { scope: __scopeAccordion, children: (0, import_jsx_runtime15.jsx)(
      Trigger,
      {
...
var Primitive4 = NODES4.reduce((primitive, node) => {
  const Slot44 = createSlot5(`Primitive.${node}`);
...
var DismissableLayerBranch = React27.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime18.jsx)(Primitive4.div, { ...props, ref: composedRefs });
});
...
function createSlot6(ownerName) {
  ...
  const Slot210 = React28.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime19.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React28.isValidElement(newElement) ? React28.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable6(child) {
  return React28.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var Primitive5 = NODES5.reduce((primitive, node) => {
  const Slot44 = createSlot6(`Primitive.${node}`);
...
var FocusScope = React30.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime21.jsx)(Primitive5.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
function createSlot7(ownerName) {
  ...
  const Slot210 = React31.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime22.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React31.isValidElement(newElement) ? React31.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive6 = NODES6.reduce((primitive, node) => {
  const Slot44 = createSlot7(`Primitive.${node}`);
...
var Portal = React33.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom.default.createPortal((0, import_jsx_runtime24.jsx)(Primitive6.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function createSlot8(ownerName) {
  ...
  const Slot210 = React34.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime25.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React34.isValidElement(newElement) ? React34.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive7 = NODES7.reduce((primitive, node) => {
  const Slot44 = createSlot8(`Primitive.${node}`);
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? React37.useLayoutEffect : React37.useEffect;
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime27.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React46.Children.map(children, (child) => (0, import_jsx_runtime27.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime27.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlay = React46.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? (0, import_jsx_runtime27.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime27.jsx)(DialogOverlayImpl, { ...overlayProps, ref: forwardedRef }) }) : null;
  }
);
DialogOverlay.displayName = OVERLAY_NAME;
var Slot9 = createSlot8("DialogOverlay.RemoveScroll");
var DialogOverlayImpl = React46.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime27.jsx)(Combination_default, { as: Slot9, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime27.jsx)(
        Primitive7.div,
        {
          "data-state": getState3(context.open),
          ...overlayProps,
...
var DialogContent = React46.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime27.jsx)(DialogContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime27.jsx)(DialogContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
      ...
      (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
        (0, import_jsx_runtime27.jsx)(TitleWarning, { titleId: context.titleId }),
        (0, import_jsx_runtime27.jsx)(DescriptionWarning, { contentRef, descriptionId: context.descriptionId })
      ] })
    ] });
  }
);
...
var DialogTitle = React46.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsx)(Primitive7.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
...
var DialogDescription = React46.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsx)(Primitive7.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
...
function createSlot9(ownerName) {
  ...
  const Slot210 = React47.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime28.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React47.isValidElement(newElement) ? React47.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable9(child) {
  return React47.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime29.jsx)(Root6, { ...dialogScope, ...alertDialogProps, modal: true });
};
...
var AlertDialogTrigger = React48.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime29.jsx)(Trigger3, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
...
var Slottable10 = createSlottable9("AlertDialogContent");
      ...
      WarningProvider,
      {
        ...
        children: (0, import_jsx_runtime29.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime29.jsxs)(
          Content3,
          {
            ...
            children: [
              (0, import_jsx_runtime29.jsx)(Slottable10, { children }),
...
// ../../node_modules/@radix-ui/react-aspect-ratio/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React49 = __toESM(require_react(), 1);
var import_jsx_runtime30 = __toESM(require_jsx_runtime(), 1);
function createSlot10(ownerName) {
  const SlotClone = createSlotClone10(ownerName);
  const Slot210 = React49.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime30.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React49.isValidElement(newElement) ? React49.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable10(child) {
  return React49.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER10;
}
...
var Primitive8 = NODES8.reduce((primitive, node) => {
  const Slot44 = createSlot10(`Primitive.${node}`);
...
var AspectRatio = React51.forwardRef(
  (props, forwardedRef) => {
...
// ../../node_modules/@radix-ui/react-avatar/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React52 = __toESM(require_react(), 1);
var import_jsx_runtime33 = __toESM(require_jsx_runtime(), 1);
function createSlot11(ownerName) {
  const SlotClone = createSlotClone11(ownerName);
  const Slot210 = React52.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React52.Children.count(newElement) > 1) return React52.Children.only(null);
          return React52.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime33.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React52.isValidElement(newElement) ? React52.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone11(ownerName) {
  const SlotClone = React52.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React52.isValidElement(children)) {
      ...
      if (children.type !== React52.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React52.cloneElement(children, props2);
    }
    return React52.Children.count(children) > 1 ? React52.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable11(child) {
  return React52.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER11;
}
...
var Primitive9 = NODES9.reduce((primitive, node) => {
  const Slot44 = createSlot11(`Primitive.${node}`);
...
var Avatar = React54.forwardRef(
  (props, forwardedRef) => {
    ...
    const [imageLoadingStatus, setImageLoadingStatus] = React54.useState("idle");
    return (0, import_jsx_runtime35.jsx)(
      AvatarProvider,
      {
        ...
        children: (0, import_jsx_runtime35.jsx)(Primitive9.span, { ...avatarProps, ref: forwardedRef })
      }
    );
  }
);
...
var AvatarImage = React54.forwardRef(
  (props, forwardedRef) => {
    ...
    return imageLoadingStatus === "loaded" ? (0, import_jsx_runtime35.jsx)(Primitive9.img, { ...imageProps, ref: forwardedRef, src }) : null;
  }
);
AvatarImage.displayName = IMAGE_NAME;
var FALLBACK_NAME = "AvatarFallback";
var AvatarFallback = React54.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAvatar, delayMs, ...fallbackProps } = props;
    const context = useAvatarContext(FALLBACK_NAME, __scopeAvatar);
    const [canRender, setCanRender] = React54.useState(delayMs === void 0);
    React54.useEffect(() => {
      if (delayMs !== void 0) {
    ...
    return canRender && context.imageLoadingStatus !== "loaded" ? (0, import_jsx_runtime35.jsx)(Primitive9.span, { ...fallbackProps, ref: forwardedRef }) : null;
  }
);
...
function useImageLoadingStatus(src, { referrerPolicy, crossOrigin }) {
  ...
  const imageRef = React54.useRef(null);
  const image = (() => {
  ...
  const [loadingStatus, setLoadingStatus] = React54.useState(
...
function usePrevious(value) {
  const ref = React55.useRef({ value, previous: value });
...
function useSize(element) {
  const [size4, setSize] = React56.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
function createSlot12(ownerName) {
  ...
  const Slot210 = React57.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime36.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React57.isValidElement(newElement) ? React57.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable12(child) {
  return React57.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER12;
}
...
var Primitive10 = NODES10.reduce((primitive, node) => {
  const Slot44 = createSlot12(`Primitive.${node}`);
...
var CheckboxTrigger = React59.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = React59.useRef(checked);
    React59.useEffect(() => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime38.jsx)(
      CheckboxProvider,
      {
        ...
        form,
        value,
        internal_do_not_use_render: ({ isFormControl: isFormControl2 }) => (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [
...
var CheckboxIndicator = React59.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = React59.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React59.useRef(isIndeterminate(checked) ? false : checked);
    return (0, import_jsx_runtime38.jsx)(
      Primitive10.input,
      {
        type: "checkbox",
...
// ../../node_modules/@radix-ui/react-context-menu/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
...
function createSlot13(ownerName) {
  ...
  const Slot210 = React60.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime39.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React60.isValidElement(newElement) ? React60.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable13(child) {
  return React60.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER13;
}
...
var Primitive11 = NODES11.reduce((primitive, node) => {
  const Slot44 = createSlot13(`Primitive.${node}`);
...
function isSlottable14(child) {
  return React63.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER14;
}
...
var Primitive12 = NODES12.reduce((primitive, node) => {
  const Slot44 = createSlot14(`Primitive.${node}`);
  const Node2 = React64.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var NAME4 = "Arrow";
var Arrow = React65.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime43.jsx)(
    Primitive12.svg,
    {
      ...
      children: props.asChild ? children : (0, import_jsx_runtime43.jsx)("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
function createSlot15(ownerName) {
  ...
  const Slot210 = React66.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime44.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React66.isValidElement(newElement) ? React66.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable15(child) {
  return React66.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER15;
}
...
var Primitive13 = NODES13.reduce((primitive, node) => {
  const Slot44 = createSlot15(`Primitive.${node}`);
...
var Popper = (props) => {
  ...
  return (0, import_jsx_runtime46.jsx)(PopperProvider, { scope: __scopePopper, anchor, onAnchorChange: setAnchor, children });
};
...
var PopperAnchor = React68.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime46.jsx)(Primitive13.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var PopperContent = React68.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow4, setArrow] = React68.useState(null);
...
function isSlottable16(child) {
  return React69.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER16;
}
...
var Primitive14 = NODES14.reduce((primitive, node) => {
  const Slot44 = createSlot16(`Primitive.${node}`);
  const Node2 = React70.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
function createSlot17(ownerName) {
  ...
  const Slot210 = React71.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React71.Children.count(newElement) > 1) return React71.Children.only(null);
          return React71.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime49.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React71.isValidElement(newElement) ? React71.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone17(ownerName) {
  const SlotClone = React71.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React71.isValidElement(children)) {
      ...
      if (children.type !== React71.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React71.cloneElement(children, props2);
    }
    return React71.Children.count(children) > 1 ? React71.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable17(child) {
  return React71.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER17;
}
...
var Primitive15 = NODES15.reduce((primitive, node) => {
  const Slot44 = createSlot17(`Primitive.${node}`);
...
var RovingFocusGroup = React73.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime51.jsx)(Collection2.Provider, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime51.jsx)(Collection2.Slot, { scope: props.__scopeRovingFocusGroup, children: (0, import_jsx_runtime51.jsx)(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
RovingFocusGroup.displayName = GROUP_NAME;
var RovingFocusGroupImpl = React73.forwardRef((props, forwardedRef) => {
  const {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = React73.useState(false);
  const handleEntryFocus = useCallbackRef(onEntryFocus);
  const getItems = useCollection2(__scopeRovingFocusGroup);
  const isClickFocusRef = React73.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = React73.useState(0);
  React73.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return (0, import_jsx_runtime51.jsx)(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: React73.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: React73.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: React73.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: React73.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
...
var RovingFocusGroupItem = React73.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var Menu = (props) => {
  ...
  const [content, setContent] = React74.useState(null);
  const isUsingKeyboardRef = React74.useRef(false);
  ...
  return (0, import_jsx_runtime52.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime52.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
      ...
      children: (0, import_jsx_runtime52.jsx)(
        ...
        {
          scope: __scopeMenu,
          onClose: React74.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React74.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...anchorProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime52.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime52.jsx)(PortalProvider2, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime52.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime52.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React74.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime52.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime52.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime52.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? (0, import_jsx_runtime52.jsx)(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime52.jsx)(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
var MenuRootContentModal = React74.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
...
var MenuRootContentNonModal = React74.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME6, props.__scopeMenu);
  return (0, import_jsx_runtime52.jsx)(
    MenuContentImpl,
    {
...
var Slot19 = createSlot16("MenuContent.ScrollLock");
var MenuContentImpl = React74.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React74.useState(null);
    const contentRef = React74.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React74.useRef(0);
    const searchRef = React74.useRef("");
    const pointerGraceTimerRef = React74.useRef(0);
    const pointerGraceIntentRef = React74.useRef(null);
    const pointerDirRef = React74.useRef("right");
    const lastPointerXRef = React74.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? Combination_default : React74.Fragment;
    const scrollLockWrapperProps = disableOutsideScroll ? { as: Slot19, allowPinchZoom: true } : void 0;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React74.useCallback((event) => {
    ...
    return (0, import_jsx_runtime52.jsx)(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React74.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React74.useCallback(
          (event) => {
        ...
        onPointerGraceIntentChange: React74.useCallback((intent) => {
          pointerGraceIntentRef.current = intent;
        }, []),
        children: (0, import_jsx_runtime52.jsx)(ScrollLockWrapper, { ...scrollLockWrapperProps, children: (0, import_jsx_runtime52.jsx)(
          FocusScope,
          {
            asChild: true,
            trapped: trapFocus,
...
var MenuGroup = React74.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...groupProps } = props;
    return (0, import_jsx_runtime52.jsx)(Primitive14.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
MenuGroup.displayName = GROUP_NAME2;
var LABEL_NAME = "MenuLabel";
var MenuLabel = React74.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...labelProps } = props;
    return (0, import_jsx_runtime52.jsx)(Primitive14.div, { ...labelProps, ref: forwardedRef });
  }
);
MenuLabel.displayName = LABEL_NAME;
var ITEM_NAME3 = "MenuItem";
var ITEM_SELECT = "menu.itemSelect";
var MenuItem = React74.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemImpl = React74.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textContent, setTextContent] = React74.useState("");
    React74.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
    ...
    return (0, import_jsx_runtime52.jsx)(
      Collection3.ItemSlot,
      {
        ...
        children: (0, import_jsx_runtime52.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: (0, import_jsx_runtime52.jsx)(
          Primitive14.div,
          {
            role: "menuitem",
...
var MenuCheckboxItem = React74.forwardRef(
  (props, forwardedRef) => {
    const { checked = false, onCheckedChange, ...checkboxItemProps } = props;
    return (0, import_jsx_runtime52.jsx)(ItemIndicatorProvider, { scope: props.__scopeMenu, checked, children: (0, import_jsx_runtime52.jsx)(
      MenuItem,
      {
...
var MenuRadioGroup = React74.forwardRef(
  (props, forwardedRef) => {
    const { value, onValueChange, ...groupProps } = props;
    const handleValueChange = useCallbackRef(onValueChange);
    return (0, import_jsx_runtime52.jsx)(RadioGroupProvider, { scope: props.__scopeMenu, value, onValueChange: handleValueChange, children: (0, import_jsx_runtime52.jsx)(MenuGroup, { ...groupProps, ref: forwardedRef }) });
  }
);
MenuRadioGroup.displayName = RADIO_GROUP_NAME;
var RADIO_ITEM_NAME = "MenuRadioItem";
var MenuRadioItem = React74.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React74.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React74.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React74.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenu, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeMenu);
    return (0, import_jsx_runtime52.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenuSubTrigger = React74.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME, props.__scopeMenu);
    const openTimerRef = React74.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React74.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React74.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React74.useEffect(() => {
    ...
    return (0, import_jsx_runtime52.jsx)(MenuAnchor, { asChild: true, ...scope, children: (0, import_jsx_runtime52.jsx)(
      MenuItemImpl,
      {
...
var MenuSubContent = React74.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext2(CONTENT_NAME6, props.__scopeMenu);
    ...
    const ref = React74.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return (0, import_jsx_runtime52.jsx)(Collection3.Provider, { scope: props.__scopeMenu, children: (0, import_jsx_runtime52.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime52.jsx)(Collection3.Slot, { scope: props.__scopeMenu, children: (0, import_jsx_runtime52.jsx)(
      MenuContentImpl,
      {
...
var ContextMenu = (props) => {
  ...
  const handleOpenChange = React75.useCallback(
    (open2) => {
      setOpen(open2);
...
var ContextMenuTrigger = React75.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME6, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React75.useRef({ x: 0, y: 0 });
    const virtualRef = React75.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React75.useRef(0);
    const clearLongPress = React75.useCallback(
    ...
    React75.useEffect(() => clearLongPress, [clearLongPress]);
    React75.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
    return (0, import_jsx_runtime53.jsxs)(import_jsx_runtime53.Fragment, { children: [
      (0, import_jsx_runtime53.jsx)(Anchor2, { ...menuScope, virtualRef }),
...
var ContextMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime53.jsx)(Portal3, { ...menuScope, ...portalProps });
};
ContextMenuPortal.displayName = PORTAL_NAME5;
var CONTENT_NAME7 = "ContextMenuContent";
var ContextMenuContent = React75.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, ...contentProps } = props;
    const context = useContextMenuContext(CONTENT_NAME7, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const hasInteractedOutsideRef = React75.useRef(false);
    return (0, import_jsx_runtime53.jsx)(
      Content23,
      {
        ...menuScope,
...
var ContextMenuGroup = React75.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, ...groupProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime53.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }
);
ContextMenuGroup.displayName = GROUP_NAME3;
var LABEL_NAME2 = "ContextMenuLabel";
var ContextMenuLabel = React75.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, ...labelProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime53.jsx)(Label, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
ContextMenuLabel.displayName = LABEL_NAME2;
var ITEM_NAME4 = "ContextMenuItem";
var ContextMenuItem = React75.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime53.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
ContextMenuItem.displayName = ITEM_NAME4;
var CHECKBOX_ITEM_NAME2 = "ContextMenuCheckboxItem";
var ContextMenuCheckboxItem = React75.forwardRef((props, forwardedRef) => {
  const { __scopeContextMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime53.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
});
ContextMenuCheckboxItem.displayName = CHECKBOX_ITEM_NAME2;
var RADIO_GROUP_NAME2 = "ContextMenuRadioGroup";
var ContextMenuRadioGroup = React75.forwardRef((props, forwardedRef) => {
  const { __scopeContextMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime53.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
});
ContextMenuRadioGroup.displayName = RADIO_GROUP_NAME2;
var RADIO_ITEM_NAME2 = "ContextMenuRadioItem";
var ContextMenuRadioItem = React75.forwardRef((props, forwardedRef) => {
  const { __scopeContextMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime53.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
});
ContextMenuRadioItem.displayName = RADIO_ITEM_NAME2;
var INDICATOR_NAME2 = "ContextMenuItemIndicator";
var ContextMenuItemIndicator = React75.forwardRef((props, forwardedRef) => {
  const { __scopeContextMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime53.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
});
ContextMenuItemIndicator.displayName = INDICATOR_NAME2;
var SEPARATOR_NAME2 = "ContextMenuSeparator";
var ContextMenuSeparator = React75.forwardRef((props, forwardedRef) => {
  const { __scopeContextMenu, ...separatorProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime53.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
});
ContextMenuSeparator.displayName = SEPARATOR_NAME2;
var ARROW_NAME3 = "ContextMenuArrow";
var ContextMenuArrow = React75.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime53.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var ContextMenuSub = (props) => {
  ...
  return (0, import_jsx_runtime53.jsx)(Sub, { ...menuScope, open, onOpenChange: setOpen, children });
};
ContextMenuSub.displayName = SUB_NAME2;
var SUB_TRIGGER_NAME2 = "ContextMenuSubTrigger";
var ContextMenuSubTrigger = React75.forwardRef((props, forwardedRef) => {
  const { __scopeContextMenu, ...triggerItemProps } = props;
  const menuScope = useMenuScope(__scopeContextMenu);
  return (0, import_jsx_runtime53.jsx)(SubTrigger, { ...menuScope, ...triggerItemProps, ref: forwardedRef });
});
ContextMenuSubTrigger.displayName = SUB_TRIGGER_NAME2;
var SUB_CONTENT_NAME2 = "ContextMenuSubContent";
var ContextMenuSubContent = React75.forwardRef((props, forwardedRef) => {
...
// ../../node_modules/@radix-ui/react-dropdown-menu/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React76 = __toESM(require_react(), 1);
var import_jsx_runtime54 = __toESM(require_jsx_runtime(), 1);
function createSlot18(ownerName) {
  const SlotClone = createSlotClone18(ownerName);
  const Slot210 = React76.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime54.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React76.isValidElement(newElement) ? React76.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable18(child) {
  return React76.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER18;
}
...
var Primitive16 = NODES16.reduce((primitive, node) => {
  const Slot44 = createSlot18(`Primitive.${node}`);
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime56.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime56.jsx)(Root32, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
DropdownMenu.displayName = DROPDOWN_MENU_NAME;
var TRIGGER_NAME7 = "DropdownMenuTrigger";
var DropdownMenuTrigger = React78.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, disabled = false, ...triggerProps } = props;
    const context = useDropdownMenuContext(TRIGGER_NAME7, __scopeDropdownMenu);
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime56.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime56.jsx)(
      Primitive16.button,
      {
        type: "button",
...
var DropdownMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime56.jsx)(Portal3, { ...menuScope, ...portalProps });
};
DropdownMenuPortal.displayName = PORTAL_NAME6;
var CONTENT_NAME8 = "DropdownMenuContent";
var DropdownMenuContent = React78.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React78.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...groupProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime56.jsx)(Group, { ...menuScope, ...groupProps, ref: forwardedRef });
  }
);
DropdownMenuGroup.displayName = GROUP_NAME4;
var LABEL_NAME3 = "DropdownMenuLabel";
var DropdownMenuLabel = React78.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...labelProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime56.jsx)(Label, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
DropdownMenuLabel.displayName = LABEL_NAME3;
var ITEM_NAME5 = "DropdownMenuItem";
var DropdownMenuItem = React78.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime56.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
DropdownMenuItem.displayName = ITEM_NAME5;
var CHECKBOX_ITEM_NAME3 = "DropdownMenuCheckboxItem";
var DropdownMenuCheckboxItem = React78.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime56.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
});
DropdownMenuCheckboxItem.displayName = CHECKBOX_ITEM_NAME3;
var RADIO_GROUP_NAME3 = "DropdownMenuRadioGroup";
var DropdownMenuRadioGroup = React78.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime56.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
});
DropdownMenuRadioGroup.displayName = RADIO_GROUP_NAME3;
var RADIO_ITEM_NAME3 = "DropdownMenuRadioItem";
var DropdownMenuRadioItem = React78.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime56.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
});
DropdownMenuRadioItem.displayName = RADIO_ITEM_NAME3;
var INDICATOR_NAME3 = "DropdownMenuItemIndicator";
var DropdownMenuItemIndicator = React78.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime56.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
});
DropdownMenuItemIndicator.displayName = INDICATOR_NAME3;
var SEPARATOR_NAME3 = "DropdownMenuSeparator";
var DropdownMenuSeparator = React78.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...separatorProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime56.jsx)(Separator, { ...menuScope, ...separatorProps, ref: forwardedRef });
});
DropdownMenuSeparator.displayName = SEPARATOR_NAME3;
var ARROW_NAME4 = "DropdownMenuArrow";
var DropdownMenuArrow = React78.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope2(__scopeDropdownMenu);
    return (0, import_jsx_runtime56.jsx)(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var DropdownMenuSub = (props) => {
  ...
  return (0, import_jsx_runtime56.jsx)(Sub, { ...menuScope, open, onOpenChange: setOpen, children });
};
var SUB_TRIGGER_NAME3 = "DropdownMenuSubTrigger";
var DropdownMenuSubTrigger = React78.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope2(__scopeDropdownMenu);
  return (0, import_jsx_runtime56.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
});
DropdownMenuSubTrigger.displayName = SUB_TRIGGER_NAME3;
var SUB_CONTENT_NAME3 = "DropdownMenuSubContent";
var DropdownMenuSubContent = React78.forwardRef((props, forwardedRef) => {
...
// ../../node_modules/@radix-ui/react-form/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React79 = __toESM(require_react(), 1);
var import_jsx_runtime57 = __toESM(require_jsx_runtime(), 1);
function createSlot19(ownerName) {
  const SlotClone = createSlotClone19(ownerName);
  const Slot210 = React79.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React79.Children.count(newElement) > 1) return React79.Children.only(null);
          return React79.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime57.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React79.isValidElement(newElement) ? React79.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Slot21 = createSlot19("Slot");
function createSlotClone19(ownerName) {
  const SlotClone = React79.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React79.isValidElement(children)) {
      ...
      if (children.type !== React79.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React79.cloneElement(children, props2);
    }
...
function isSlottable19(child) {
  return React79.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER19;
}
...
var Primitive17 = NODES17.reduce((primitive, node) => {
  const Slot44 = createSlot19(`Primitive.${node}`);
  const Node2 = React80.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var NAME5 = "Label";
var Label3 = React81.forwardRef((props, forwardedRef) => {
...
var Form = React82.forwardRef(
  (props, forwardedRef) => {
    ...
    const formRef = React82.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React82.useState({});
    const getFieldValidity = React82.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React82.useCallback(
    ...
    const handleFieldValiditionClear = React82.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React82.useState({});
    const getFieldCustomMatcherEntries = React82.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React82.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React82.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React82.useState({});
    const getFieldCustomErrors = React82.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React82.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React82.useState({});
    const handleFieldMessageIdAdd = React82.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React82.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React82.useCallback(
...
var FormField = React82.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, name, serverInvalid = false, ...fieldProps } = props;
    const validationContext = useValidationContext(FIELD_NAME, __scopeForm);
    const validity = validationContext.getFieldValidity(name);
    const id = useId();
    return (0, import_jsx_runtime60.jsx)(FormFieldProvider, { scope: __scopeForm, id, name, serverInvalid, children: (0, import_jsx_runtime60.jsx)(
      Primitive17.div,
      {
...
var FormLabel = React82.forwardRef(
  (props, forwardedRef) => {
...
var FormControl = React82.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React82.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React82.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React82.forwardRef(
  (props, forwardedRef) => {
    const { match, name: nameProp, ...messageProps } = props;
    const fieldContext = useFormFieldContext(MESSAGE_NAME, props.__scopeForm);
    const name = nameProp ?? fieldContext.name;
    if (match === void 0) {
      return (0, import_jsx_runtime60.jsx)(FormMessageImpl, { ...messageProps, ref: forwardedRef, name, children: props.children || DEFAULT_INVALID_MESSAGE });
    } else if (typeof match === "function") {
      return (0, import_jsx_runtime60.jsx)(FormCustomMessage, { match, ...messageProps, ref: forwardedRef, name });
    } else {
      return (0, import_jsx_runtime60.jsx)(FormBuiltInMessage, { match, ...messageProps, ref: forwardedRef, name });
    }
  }
);
FormMessage.displayName = MESSAGE_NAME;
var FormBuiltInMessage = React82.forwardRef(
  (props, forwardedRef) => {
    ...
    if (matches) {
      return (0, import_jsx_runtime60.jsx)(FormMessageImpl, { ref: forwardedRef, ...messageProps, name, children: children ?? DEFAULT_BUILT_IN_MESSAGES[match] });
    }
    return null;
  }
);
var FormCustomMessage = React82.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React82.useMemo(() => ({ id, match }), [id, match]);
    ...
    if (matches) {
      return (0, import_jsx_runtime60.jsx)(FormMessageImpl, { id, ref: composedRef, ...messageProps, name, children: children ?? DEFAULT_INVALID_MESSAGE });
    }
    return null;
  }
);
var FormMessageImpl = React82.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime60.jsx)(Primitive17.span, { id, ...messageProps, ref: forwardedRef });
  }
);
...
var FormValidityState = (props) => {
  ...
  const name = nameProp ?? fieldContext.name;
  const validity = validationContext.getFieldValidity(name);
  return (0, import_jsx_runtime60.jsx)(import_jsx_runtime60.Fragment, { children: children(validity) });
};
FormValidityState.displayName = VALIDITY_STATE_NAME;
var SUBMIT_NAME = "FormSubmit";
var FormSubmit = React82.forwardRef(
  (props, forwardedRef) => {
    const { __scopeForm, ...submitProps } = props;
    return (0, import_jsx_runtime60.jsx)(Primitive17.button, { type: "submit", ...submitProps, ref: forwardedRef });
  }
);
...
// ../../node_modules/@radix-ui/react-hover-card/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React83 = __toESM(require_react(), 1);
var import_jsx_runtime61 = __toESM(require_jsx_runtime(), 1);
function createSlot20(ownerName) {
  const SlotClone = createSlotClone20(ownerName);
  const Slot210 = React83.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime61.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React83.isValidElement(newElement) ? React83.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable20(child) {
  return React83.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER20;
}
...
var Primitive18 = NODES18.reduce((primitive, node) => {
  const Slot44 = createSlot20(`Primitive.${node}`);
  const Node2 = React84.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime62.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var HoverCard = (props) => {
  ...
  const openTimerRef = React85.useRef(0);
  const closeTimerRef = React85.useRef(0);
  const hasSelectionRef = React85.useRef(false);
  const isPointerDownOnContentRef = React85.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleOpen = React85.useCallback(() => {
  ...
  const handleDismiss = React85.useCallback(() => setOpen(false), [setOpen]);
  React85.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
  ...
  return (0, import_jsx_runtime63.jsx)(
    HoverCardProvider,
    {
      ...
      children: (0, import_jsx_runtime63.jsx)(Root24, { ...popperScope, children })
    }
  );
};
HoverCard.displayName = HOVERCARD_NAME;
var TRIGGER_NAME8 = "HoverCardTrigger";
var HoverCardTrigger = React85.forwardRef(
  (props, forwardedRef) => {
    const { __scopeHoverCard, ...triggerProps } = props;
    const context = useHoverCardContext(TRIGGER_NAME8, __scopeHoverCard);
    const popperScope = usePopperScope2(__scopeHoverCard);
    return (0, import_jsx_runtime63.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime63.jsx)(
      Primitive18.a,
      {
        "data-state": context.open ? "open" : "closed",
        ...triggerProps,
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime63.jsx)(PortalProvider3, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime63.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime63.jsx)(Portal, { asChild: true, container, children }) }) });
};
HoverCardPortal.displayName = PORTAL_NAME7;
var CONTENT_NAME9 = "HoverCardContent";
var HoverCardContent = React85.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime63.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime63.jsx)(
...
var HoverCardContentImpl = React85.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React85.useState(false);
  React85.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React85.forwardRef(
  (props, forwardedRef) => {
    const { __scopeHoverCard, ...arrowProps } = props;
    const popperScope = usePopperScope2(__scopeHoverCard);
    return (0, import_jsx_runtime63.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
__export(dist_exports20, {
  Root: () => Slot23,
  Slot: () => Slot23,
  Slottable: () => Slottable22,
  createSlot: () => createSlot21,
  createSlottable: () => createSlottable21
});
...
function createSlot21(ownerName) {
  ...
  const Slot210 = React86.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime64.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React86.isValidElement(newElement) ? React86.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime64.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
...
function createSlottable21(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime64.jsx)(import_jsx_runtime64.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
...
function isSlottable21(child) {
  return React86.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER21;
}
...
var Primitive19 = NODES19.reduce((primitive, node) => {
  const Slot44 = createSlot21(`Primitive.${node}`);
...
var NAME6 = "Label";
var Label5 = React88.forwardRef((props, forwardedRef) => {
...
// ../../node_modules/@radix-ui/react-menubar/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React89 = __toESM(require_react(), 1);
var import_jsx_runtime67 = __toESM(require_jsx_runtime(), 1);
function createSlot22(ownerName) {
  const SlotClone = createSlotClone22(ownerName);
  const Slot210 = React89.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime67.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React89.isValidElement(newElement) ? React89.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable22(child) {
  return React89.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER22;
}
...
var Primitive20 = NODES20.reduce((primitive, node) => {
  const Slot44 = createSlot22(`Primitive.${node}`);
  const Node2 = React90.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var Menubar = React91.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React91.useState(null);
    return (0, import_jsx_runtime69.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React91.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React91.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React91.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime69.jsx)(Collection4.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime69.jsx)(Collection4.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime69.jsx)(
          Root10,
          {
            asChild: true,
            ...rovingFocusGroupScope,
            ...
            children: (0, import_jsx_runtime69.jsx)(Primitive20.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React91.useRef(false);
...
var MenubarTrigger = React91.forwardRef(
  (props, forwardedRef) => {
    ...
    const [isFocused, setIsFocused] = React91.useState(false);
    const open = context.value === menuContext.value;
    return (0, import_jsx_runtime69.jsx)(Collection4.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime69.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime69.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime69.jsx)(
          Primitive20.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarContent = React91.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasInteractedOutsideRef = React91.useRef(false);
    return (0, import_jsx_runtime69.jsx)(
      Content23,
      {
...
var MenubarGroup = React91.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React91.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React91.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...itemProps } = props;
    const menuScope = useMenuScope3(__scopeMenubar);
    return (0, import_jsx_runtime69.jsx)(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
MenubarItem.displayName = ITEM_NAME6;
var CHECKBOX_ITEM_NAME4 = "MenubarCheckboxItem";
var MenubarCheckboxItem = React91.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React91.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React91.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React91.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React91.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React91.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React91.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React91.forwardRef(
  (props, forwardedRef) => {
...
function createSlot23(ownerName) {
  ...
  const Slot210 = React92.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React92.Children.count(newElement) > 1) return React92.Children.only(null);
          return React92.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime70.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React92.isValidElement(newElement) ? React92.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone23(ownerName) {
  const SlotClone = React92.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React92.isValidElement(children)) {
      ...
      if (children.type !== React92.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React92.cloneElement(children, props2);
    }
...
function isSlottable23(child) {
  return React92.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER23;
}
...
var Primitive21 = NODES21.reduce((primitive, node) => {
  const Slot44 = createSlot23(`Primitive.${node}`);
...
var NavigationMenu = React94.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React94.useState(null);
    const composedRef = useComposedRefs(forwardedRef, (node) => setNavigationMenu(node));
    const direction = useDirection(dir);
    const openTimerRef = React94.useRef(0);
    const closeTimerRef = React94.useRef(0);
    const skipDelayTimerRef = React94.useRef(0);
    const [isOpenDelayed, setIsOpenDelayed] = React94.useState(true);
    const [value, setValue] = useControllableState({
      prop: valueProp,
      onChange: (value2) => {
        const isOpen = value2 !== "";
    ...
    const startCloseTimer = React94.useCallback(() => {
      window.clearTimeout(closeTimerRef.current);
      closeTimerRef.current = window.setTimeout(() => setValue(""), 150);
    }, [setValue]);
    const handleOpen = React94.useCallback(
      (itemValue) => {
        window.clearTimeout(closeTimerRef.current);
        setValue(itemValue);
      },
    ...
    const handleDelayedOpen = React94.useCallback(
      (itemValue) => {
...
var NavigationMenuSub = React94.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
    ...
    return (0, import_jsx_runtime72.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime72.jsx)(Primitive21.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewport, setViewport] = React94.useState(null);
  const [viewportContent, setViewportContent] = React94.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React94.useState(null);
  return (0, import_jsx_runtime72.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React94.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React94.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
...
var NavigationMenuList = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...listProps } = props;
    const context = useNavigationMenuContext(LIST_NAME, __scopeNavigationMenu);
    const list = (0, import_jsx_runtime72.jsx)(Primitive21.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime72.jsx)(Primitive21.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime72.jsx)(Collection5.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime72.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
...
var NavigationMenuItem = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, value: valueProp, ...itemProps } = props;
    const autoValue = useId();
    const value = valueProp || autoValue || "LEGACY_REACT_AUTO_VALUE";
    const contentRef = React94.useRef(null);
    const triggerRef = React94.useRef(null);
    const focusProxyRef = React94.useRef(null);
    const restoreContentTabOrderRef = React94.useRef(() => {
    });
    const wasEscapeCloseRef = React94.useRef(false);
    const handleContentEntry = React94.useCallback((side = "start") => {
    ...
    const handleContentExit = React94.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates2(contentRef.current);
    ...
    return (0, import_jsx_runtime72.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime72.jsx)(Primitive21.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React94.forwardRef((props, forwardedRef) => {
  ...
  const hasPointerMoveOpenedRef = React94.useRef(false);
  const wasClickCloseRef = React94.useRef(false);
...
var NavigationMenuLink = React94.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuIndicator = React94.forwardRef((props, forwardedRef) => {
...
var NavigationMenuIndicatorImpl = React94.forwardRef((props, forwardedRef) => {
  ...
  const [activeTrigger, setActiveTrigger] = React94.useState(
    null
  );
  const [position, setPosition] = React94.useState(null);
...
var NavigationMenuContent = React94.forwardRef((props, forwardedRef) => {
  const { forceMount, ...contentProps } = props;
...
var ViewportContentMounter = React94.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME11, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React94.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection5(__scopeNavigationMenu);
  const prevMotionAttributeRef = React94.useRef(null);
  ...
  const motionAttribute = React94.useMemo(() => {
    const items = getItems();
...
var NavigationMenuViewport = React94.forwardRef((props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React94.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React94.useState(null);
  const [content, setContent] = React94.useState(null);
  ...
  return (0, import_jsx_runtime72.jsx)(
    Primitive21.div,
    {
      ...
      children: Array.from(viewportContentContext.items).map(([value, { ref, forceMount, ...props2 }]) => {
        ...
        return (0, import_jsx_runtime72.jsx)(Presence, { present: forceMount || isActive, children: (0, import_jsx_runtime72.jsx)(
          NavigationMenuContentImpl,
          {
            ...props2,
...
var FocusGroup = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const context = useNavigationMenuContext(FOCUS_GROUP_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime72.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime72.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime72.jsx)(Primitive21.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
var ARROW_KEYS = ["ArrowRight", "ArrowLeft", "ArrowUp", "ArrowDown"];
var FOCUS_GROUP_ITEM_NAME = "FocusGroupItem";
var FocusGroupItem = React94.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
...
// ../../node_modules/@radix-ui/react-one-time-password-field/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React95 = __toESM(require_react(), 1);
var import_jsx_runtime73 = __toESM(require_jsx_runtime(), 1);
function createSlot24(ownerName) {
  const SlotClone = createSlotClone24(ownerName);
  const Slot210 = React95.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React95.Children.count(newElement) > 1) return React95.Children.only(null);
          return React95.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime73.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React95.isValidElement(newElement) ? React95.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone24(ownerName) {
  const SlotClone = React95.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React95.isValidElement(children)) {
      ...
      if (children.type !== React95.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React95.cloneElement(children, props2);
    }
    return React95.Children.count(children) > 1 ? React95.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable24(child) {
  return React95.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER24;
}
...
var Primitive22 = NODES22.reduce((primitive, node) => {
  const Slot44 = createSlot24(`Primitive.${node}`);
...
var OneTimePasswordField = React97.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React97.useCallback(
      (value2) => {
    ...
    const controlledValue = React97.useMemo(() => {
    ...
    const validationTypeRef = React97.useRef(validation);
    React97.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React97.useRef(null);
    const userActionRef = React97.useRef(null);
    ...
    const locateForm = React97.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React97.useCallback(() => {
    ...
    const valueRef = React97.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React97.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React97.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React97.useState(null);
  ...
  const keyboardActionTimeoutRef = React97.useRef(null);
  React97.useEffect(() => {
    return () => {
...
// ../../node_modules/@radix-ui/react-password-toggle-field/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React98 = __toESM(require_react(), 1);
var import_jsx_runtime76 = __toESM(require_jsx_runtime(), 1);
function createSlot25(ownerName) {
  const SlotClone = createSlotClone25(ownerName);
  const Slot210 = React98.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React98.Children.count(newElement) > 1) return React98.Children.only(null);
          return React98.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime76.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React98.isValidElement(newElement) ? React98.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime76.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
...
function createSlottable25(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime76.jsx)(import_jsx_runtime76.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
...
function isSlottable25(child) {
  return React98.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER25;
}
...
var Primitive23 = NODES23.reduce((primitive, node) => {
  const Slot44 = createSlot25(`Primitive.${node}`);
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React100.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React100.useCallback(
  ...
  const focusState = React100.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React100.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React100.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React100.useState(void 0);
    const elementRef = React100.useRef(null);
...
var PasswordToggleFieldIcon = React100.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime78.jsx)(Primitive23.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
function createSlot26(ownerName) {
  ...
  const Slot210 = React101.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime79.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React101.isValidElement(newElement) ? React101.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Primitive24 = NODES24.reduce((primitive, node) => {
  const Slot44 = createSlot26(`Primitive.${node}`);
...
var Popover = (props) => {
  ...
  const triggerRef = React103.useRef(null);
  const [hasCustomAnchor, setHasCustomAnchor] = React103.useState(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  return (0, import_jsx_runtime81.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime81.jsx)(
    PopoverProvider,
    {
      ...
      open,
      onOpenChange: setOpen,
      onOpenToggle: React103.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
      hasCustomAnchor,
      onCustomAnchorAdd: React103.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React103.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React103.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime81.jsx)(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
PopoverAnchor.displayName = ANCHOR_NAME3;
var TRIGGER_NAME11 = "PopoverTrigger";
var PopoverTrigger = React103.forwardRef(
  (props, forwardedRef) => {
    const { __scopePopover, ...triggerProps } = props;
    const context = usePopoverContext(TRIGGER_NAME11, __scopePopover);
    const popperScope = usePopperScope3(__scopePopover);
    const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
    const trigger = (0, import_jsx_runtime81.jsx)(
      Primitive24.button,
      {
        type: "button",
        "aria-haspopup": "dialog",
    ...
    return context.hasCustomAnchor ? trigger : (0, import_jsx_runtime81.jsx)(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return (0, import_jsx_runtime81.jsx)(PortalProvider4, { scope: __scopePopover, forceMount, children: (0, import_jsx_runtime81.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime81.jsx)(Portal, { asChild: true, container, children }) }) });
};
PopoverPortal.displayName = PORTAL_NAME9;
var CONTENT_NAME12 = "PopoverContent";
var PopoverContent = React103.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime81.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime81.jsx)(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime81.jsx)(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
PopoverContent.displayName = CONTENT_NAME12;
var Slot29 = createSlot26("PopoverContent.RemoveScroll");
var PopoverContentModal = React103.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
    const contentRef = React103.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React103.useRef(false);
    React103.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
    return (0, import_jsx_runtime81.jsx)(Combination_default, { as: Slot29, allowPinchZoom: true, children: (0, import_jsx_runtime81.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContentNonModal = React103.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME12, props.__scopePopover);
    const hasInteractedOutsideRef = React103.useRef(false);
    const hasPointerDownOutsideRef = React103.useRef(false);
...
var PopoverContentImpl = React103.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React103.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React103.forwardRef(
  (props, forwardedRef) => {
    const { __scopePopover, ...arrowProps } = props;
    const popperScope = usePopperScope3(__scopePopover);
    return (0, import_jsx_runtime81.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
// ../../node_modules/@radix-ui/react-progress/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React104 = __toESM(require_react(), 1);
var import_jsx_runtime82 = __toESM(require_jsx_runtime(), 1);
function createSlot27(ownerName) {
  const SlotClone = createSlotClone27(ownerName);
  const Slot210 = React104.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime82.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React104.isValidElement(newElement) ? React104.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable27(child) {
  return React104.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER27;
}
...
var Primitive25 = NODES25.reduce((primitive, node) => {
  const Slot44 = createSlot27(`Primitive.${node}`);
  const Node2 = React105.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var Progress = React106.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
    ...
    return (0, import_jsx_runtime84.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, children: (0, import_jsx_runtime84.jsx)(
      Primitive25.div,
      {
        "aria-valuemax": max2,
        "aria-valuemin": 0,
...
var ProgressIndicator = React106.forwardRef(
  (props, forwardedRef) => {
...
function createSlot28(ownerName) {
  ...
  const Slot210 = React107.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React107.Children.count(newElement) > 1) return React107.Children.only(null);
          return React107.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime85.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React107.isValidElement(newElement) ? React107.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime85.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
var Slot31 = createSlot28("Slot");
function createSlotClone28(ownerName) {
  const SlotClone = React107.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React107.isValidElement(children)) {
      const childrenRef = getElementRef29(children);
      const props2 = mergeProps28(slotProps, children.props);
      if (children.type !== React107.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React107.cloneElement(children, props2);
    }
    return React107.Children.count(children) > 1 ? React107.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable28(child) {
  return React107.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER28;
}
...
function getElementRef29(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive26 = NODES26.reduce((primitive, node) => {
  const Slot44 = createSlot28(`Primitive.${node}`);
  const Node2 = React108.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime86.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Radio = React109.forwardRef(
  (props, forwardedRef) => {
    ...
    const [button, setButton] = React109.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React109.useRef(false);
    const isFormControl2 = button ? form || !!button.closest("form") : true;
    return (0, import_jsx_runtime87.jsxs)(RadioProvider, { scope: __scopeRadio, checked, disabled, children: [
      ...
      isFormControl2 && (0, import_jsx_runtime87.jsx)(
        RadioBubbleInput,
        {
          control: button,
...
var RadioIndicator = React109.forwardRef(
  (props, forwardedRef) => {
    const { __scopeRadio, forceMount, ...indicatorProps } = props;
    const context = useRadioContext(INDICATOR_NAME7, __scopeRadio);
    return (0, import_jsx_runtime87.jsx)(Presence, { present: forceMount || context.checked, children: (0, import_jsx_runtime87.jsx)(
      Primitive26.span,
      {
...
var RadioBubbleInput = React109.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var RadioGroupIndicator = React210.forwardRef(
  (props, forwardedRef) => {
    ...
    const radioScope = useRadioScope(__scopeRadioGroup);
    return (0, import_jsx_runtime88.jsx)(RadioIndicator, { ...radioScope, ...indicatorProps, ref: forwardedRef });
  }
);
...
function createSlot29(ownerName) {
  const SlotClone = createSlotClone29(ownerName);
  const Slot210 = React110.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React110.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable29);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React110.Children.count(newElement) > 1) return React110.Children.only(null);
          return React110.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime89.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React110.isValidElement(newElement) ? React110.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime89.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
var Slot32 = createSlot29("Slot");
function createSlotClone29(ownerName) {
  const SlotClone = React110.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React110.isValidElement(children)) {
      const childrenRef = getElementRef30(children);
      const props2 = mergeProps29(slotProps, children.props);
      if (children.type !== React110.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React110.cloneElement(children, props2);
    }
    return React110.Children.count(children) > 1 ? React110.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER29 = Symbol("radix.slottable");
function createSlottable29(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime89.jsx)(import_jsx_runtime89.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER29;
  return Slottable210;
}
var Slottable30 = createSlottable29("Slottable");
function isSlottable29(child) {
  return React110.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER29;
}
function mergeProps29(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef30(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive27 = NODES27.reduce((primitive, node) => {
  const Slot44 = createSlot29(`Primitive.${node}`);
  const Node2 = React111.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime90.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
function useStateMachine2(initialState, machine) {
  return React112.useReducer((state, event) => {
    const nextState = machine[state][event];
    return nextState ?? state;
  }, initialState);
}
    ...
    return (0, import_jsx_runtime91.jsxs)(import_jsx_runtime91.Fragment, { children: [
      ...
      (0, import_jsx_runtime91.jsx)(
        Primitive27.div,
        {
          ...
          children: (0, import_jsx_runtime91.jsx)("div", { ref: context.onContentChange, style: { minWidth: "100%", display: "table" }, children })
        }
      )
    ] });
  }
...
var ScrollAreaScrollbar = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.type === "hover" ? (0, import_jsx_runtime91.jsx)(ScrollAreaScrollbarHover, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "scroll" ? (0, import_jsx_runtime91.jsx)(ScrollAreaScrollbarScroll, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "auto" ? (0, import_jsx_runtime91.jsx)(ScrollAreaScrollbarAuto, { ...scrollbarProps, ref: forwardedRef, forceMount }) : context.type === "always" ? (0, import_jsx_runtime91.jsx)(ScrollAreaScrollbarVisible, { ...scrollbarProps, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaScrollbarHover = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime91.jsx)(Presence, { present: forceMount || visible, children: (0, import_jsx_runtime91.jsx)(
...
var ScrollAreaScrollbarScroll = React211.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime91.jsx)(Presence, { present: forceMount || state !== "hidden", children: (0, import_jsx_runtime91.jsx)(
...
var ScrollAreaThumb = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime91.jsx)(Presence, { present: forceMount || scrollbarContext.hasThumb, children: (0, import_jsx_runtime91.jsx)(ScrollAreaThumbImpl, { ref: forwardedRef, ...thumbProps }) });
  }
);
...
var ScrollAreaCorner = React211.forwardRef(
  (props, forwardedRef) => {
    ...
    return hasCorner ? (0, import_jsx_runtime91.jsx)(ScrollAreaCornerImpl, { ...props, ref: forwardedRef }) : null;
  }
);
...
var ScrollAreaCornerImpl = React211.forwardRef((props, forwardedRef) => {
  ...
  return hasSize ? (0, import_jsx_runtime91.jsx)(
    Primitive27.div,
    {
      ...cornerProps,
      ref: forwardedRef,
...
function createSlot30(ownerName) {
  const SlotClone = createSlotClone30(ownerName);
  const Slot210 = React113.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React113.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable30);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React113.Children.count(newElement) > 1) return React113.Children.only(null);
          return React113.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime92.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React113.isValidElement(newElement) ? React113.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Slot33 = createSlot30("Slot");
function createSlotClone30(ownerName) {
  const SlotClone = React113.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React113.isValidElement(children)) {
      const childrenRef = getElementRef31(children);
      const props2 = mergeProps30(slotProps, children.props);
      if (children.type !== React113.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React113.cloneElement(children, props2);
    }
    return React113.Children.count(children) > 1 ? React113.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER30 = Symbol("radix.slottable");
function createSlottable30(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime92.jsx)(import_jsx_runtime92.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER30;
  return Slottable210;
}
var Slottable31 = createSlottable30("Slottable");
function isSlottable30(child) {
  return React113.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER30;
}
function mergeProps30(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef31(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive28 = NODES28.reduce((primitive, node) => {
  const Slot44 = createSlot30(`Primitive.${node}`);
  const Node2 = React114.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var Select = (props) => {
  ...
  const [trigger, setTrigger] = React115.useState(null);
  const [valueNode, setValueNode] = React115.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React115.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React115.useRef(null);
  const isFormControl2 = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React115.useState(/* @__PURE__ */ new Set());
  const nativeSelectKey = Array.from(nativeOptionsSet).map((option) => option.props.value).join(";");
  return (0, import_jsx_runtime94.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime94.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime94.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime94.jsx)(
          SelectNativeOptionsProvider,
          {
            scope: props.__scopeSelect,
            onNativeOptionAdd: React115.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React115.useCallback((option) => {
        ...
        isFormControl2 ? (0, import_jsx_runtime94.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime94.jsx)("option", { value: "" }) : null,
...
var SelectTrigger = React115.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React115.useRef("touch");
    ...
    return (0, import_jsx_runtime94.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime94.jsx)(
      Primitive28.button,
      {
        type: "button",
        role: "combobox",
...
var SelectValue = React115.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime94.jsx)(
      Primitive28.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime94.jsx)(import_jsx_runtime94.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React115.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, children, ...iconProps } = props;
    return (0, import_jsx_runtime94.jsx)(Primitive28.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME10 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime94.jsx)(Portal, { asChild: true, ...props });
};
SelectPortal.displayName = PORTAL_NAME10;
var CONTENT_NAME13 = "SelectContent";
var SelectContent = React115.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React115.useState();
    useLayoutEffect2(() => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM32.createPortal(
        (0, import_jsx_runtime94.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime94.jsx)(Collection7.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime94.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime94.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
...
var Slot34 = createSlot30("SelectContent.RemoveScroll");
var SelectContentImpl = React115.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [content, setContent] = React115.useState(null);
    const [viewport, setViewport] = React115.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React115.useState(null);
    const [selectedItemText, setSelectedItemText] = React115.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React115.useState(false);
    const firstValidItemFoundRef = React115.useRef(false);
    React115.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React115.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React115.useCallback(
    ...
    const itemRefCallback = React115.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React115.useCallback(() => content?.focus(), [content]);
    const itemTextRefCallback = React115.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
    ...
    return (0, import_jsx_runtime94.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime94.jsx)(Combination_default, { as: Slot34, allowPinchZoom: true, children: (0, import_jsx_runtime94.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectItemAlignedPosition = React115.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React115.useState(null);
  const [content, setContent] = React115.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React115.useRef(false);
  const shouldRepositionRef = React115.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React115.useCallback(() => {
  ...
  const [contentZIndex, setContentZIndex] = React115.useState();
  useLayoutEffect2(() => {
    if (content) setContentZIndex(window.getComputedStyle(content).zIndex);
  }, [content]);
  const handleScrollButtonChange = React115.useCallback(
    (node) => {
...
var SelectPopperPosition = React115.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React115.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React115.useRef(0);
    return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime94.Fragment, { children: [
      ...
      (0, import_jsx_runtime94.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime94.jsx)(
        Primitive28.div,
        {
...
var SelectGroup = React115.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...groupProps } = props;
    const groupId = useId();
    return (0, import_jsx_runtime94.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime94.jsx)(Primitive28.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
SelectGroup.displayName = GROUP_NAME6;
var LABEL_NAME6 = "SelectLabel";
var SelectLabel = React115.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...labelProps } = props;
    const groupContext = useSelectGroupContext(LABEL_NAME6, __scopeSelect);
    return (0, import_jsx_runtime94.jsx)(Primitive28.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItem = React115.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React115.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime94.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React115.useCallback((node) => {
...
var SelectItemText = React115.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React115.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React115.useMemo(
      () => (0, import_jsx_runtime94.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime94.Fragment, { children: [
      (0, import_jsx_runtime94.jsx)(Primitive28.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React115.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...itemIndicatorProps } = props;
    const itemContext = useSelectItemContext(ITEM_INDICATOR_NAME2, __scopeSelect);
    return itemContext.isSelected ? (0, import_jsx_runtime94.jsx)(Primitive28.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
SelectItemIndicator.displayName = ITEM_INDICATOR_NAME2;
var SCROLL_UP_BUTTON_NAME = "SelectScrollUpButton";
var SelectScrollUpButton = React115.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React115.useState(false);
  ...
  return canScrollUp ? (0, import_jsx_runtime94.jsx)(
...
var SelectScrollDownButton = React115.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React115.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
  ...
  return canScrollDown ? (0, import_jsx_runtime94.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectScrollButtonImpl = React115.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React115.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React115.useCallback(() => {
...
var SelectSeparator = React115.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, ...separatorProps } = props;
    return (0, import_jsx_runtime94.jsx)(Primitive28.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
SelectSeparator.displayName = SEPARATOR_NAME5;
var ARROW_NAME8 = "SelectArrow";
var SelectArrow = React115.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime94.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
SelectArrow.displayName = ARROW_NAME8;
var BUBBLE_INPUT_NAME3 = "SelectBubbleInput";
var SelectBubbleInput = React115.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React115.useRef("");
  const timerRef = React115.useRef(0);
  const handleTypeaheadSearch = React115.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React115.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React115.useEffect(() => {
...
// ../../node_modules/@radix-ui/react-separator/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React116 = __toESM(require_react(), 1);
var import_jsx_runtime95 = __toESM(require_jsx_runtime(), 1);
function createSlot31(ownerName) {
  const SlotClone = createSlotClone31(ownerName);
  const Slot210 = React116.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React116.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable31);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
      ...
      return (0, import_jsx_runtime95.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React116.isValidElement(newElement) ? React116.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Slot35 = createSlot31("Slot");
function createSlotClone31(ownerName) {
  const SlotClone = React116.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React116.isValidElement(children)) {
      const childrenRef = getElementRef32(children);
      const props2 = mergeProps31(slotProps, children.props);
...
var SLOTTABLE_IDENTIFIER31 = Symbol("radix.slottable");
function createSlottable31(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime95.jsx)(import_jsx_runtime95.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER31;
  return Slottable210;
}
var Slottable32 = createSlottable31("Slottable");
function isSlottable31(child) {
  return React116.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER31;
}
function mergeProps31(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef32(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive29 = NODES29.reduce((primitive, node) => {
  const Slot44 = createSlot31(`Primitive.${node}`);
  const Node2 = React117.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime96.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Separator4 = React118.forwardRef((props, forwardedRef) => {
...
// ../../node_modules/@radix-ui/react-slider/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React119 = __toESM(require_react(), 1);
var import_jsx_runtime98 = __toESM(require_jsx_runtime(), 1);
function createSlot32(ownerName) {
  const SlotClone = createSlotClone32(ownerName);
  const Slot210 = React119.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React119.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable32);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React119.Children.count(newElement) > 1) return React119.Children.only(null);
          return React119.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime98.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React119.isValidElement(newElement) ? React119.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Slot36 = createSlot32("Slot");
function createSlotClone32(ownerName) {
  const SlotClone = React119.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React119.isValidElement(children)) {
      const childrenRef = getElementRef33(children);
      const props2 = mergeProps32(slotProps, children.props);
      if (children.type !== React119.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React119.cloneElement(children, props2);
    }
    return React119.Children.count(children) > 1 ? React119.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER32 = Symbol("radix.slottable");
function createSlottable32(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime98.jsx)(import_jsx_runtime98.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER32;
  return Slottable210;
}
var Slottable33 = createSlottable32("Slottable");
function isSlottable32(child) {
  return React119.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER32;
}
function mergeProps32(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef33(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive30 = NODES30.reduce((primitive, node) => {
  const Slot44 = createSlot32(`Primitive.${node}`);
  const Node2 = React120.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var Slider = React121.forwardRef(
  (props, forwardedRef) => {
    const {
      name,
      min: min2 = 0,
    ...
    const thumbRefs = React121.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React121.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React121.useRef(values);
    ...
    return (0, import_jsx_runtime100.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime100.jsx)(Collection8.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime100.jsx)(Collection8.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime100.jsx)(
          SliderOrientation,
          {
...
var SliderHorizontal = React121.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React121.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React121.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React121.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const sliderRef = React121.useRef(null);
...
var SliderImpl = React121.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React121.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React121.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React121.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React121.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index2 = React121.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime100.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index: index2 });
  }
);
var SliderThumbImpl = React121.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime100.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime100.jsx)(Collection8.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime100.jsx)(
            Primitive30.span,
            {
              role: "slider",
          ...
          isFormControl2 && (0, import_jsx_runtime100.jsx)(
            SliderBubbleInput,
            {
...
var SliderBubbleInput = React121.forwardRef(
...
function createSlot33(ownerName) {
  const SlotClone = createSlotClone33(ownerName);
  const Slot210 = React122.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React122.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable33);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
      ...
      return (0, import_jsx_runtime101.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React122.isValidElement(newElement) ? React122.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Slot37 = createSlot33("Slot");
function createSlotClone33(ownerName) {
  const SlotClone = React122.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React122.isValidElement(children)) {
      const childrenRef = getElementRef34(children);
      const props2 = mergeProps33(slotProps, children.props);
...
var SLOTTABLE_IDENTIFIER33 = Symbol("radix.slottable");
function createSlottable33(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime101.jsx)(import_jsx_runtime101.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER33;
  return Slottable210;
}
var Slottable34 = createSlottable33("Slottable");
function isSlottable33(child) {
  return React122.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER33;
}
function mergeProps33(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef34(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive31 = NODES31.reduce((primitive, node) => {
  const Slot44 = createSlot33(`Primitive.${node}`);
...
var Switch = React124.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSwitch,
      name,
    ...
    const [button, setButton] = React124.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setButton(node));
    const hasConsumerStoppedPropagationRef = React124.useRef(false);
    const isFormControl2 = button ? form || !!button.closest("form") : true;
    const [checked, setChecked] = useControllableState({
      prop: checkedProp,
      defaultProp: defaultChecked ?? false,
    ...
    return (0, import_jsx_runtime103.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
      ...
      isFormControl2 && (0, import_jsx_runtime103.jsx)(
        SwitchBubbleInput,
        {
          control: button,
          bubbles: !hasConsumerStoppedPropagationRef.current,
...
var SwitchThumb = React124.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React124.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
function createSlot34(ownerName) {
  const SlotClone = createSlotClone34(ownerName);
  const Slot210 = React125.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React125.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable34);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React125.Children.count(newElement) > 1) return React125.Children.only(null);
          return React125.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime104.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React125.isValidElement(newElement) ? React125.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime104.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
var Slot38 = createSlot34("Slot");
function createSlotClone34(ownerName) {
  const SlotClone = React125.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React125.isValidElement(children)) {
      const childrenRef = getElementRef35(children);
      const props2 = mergeProps34(slotProps, children.props);
      if (children.type !== React125.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React125.cloneElement(children, props2);
    }
    return React125.Children.count(children) > 1 ? React125.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER34 = Symbol("radix.slottable");
function createSlottable34(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime104.jsx)(import_jsx_runtime104.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER34;
  return Slottable210;
}
var Slottable35 = createSlottable34("Slottable");
function isSlottable34(child) {
  return React125.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER34;
}
function mergeProps34(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef35(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive32 = NODES32.reduce((primitive, node) => {
  const Slot44 = createSlot34(`Primitive.${node}`);
  const Node2 = React126.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime105.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var TabsList = React127.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React127.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React127.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React127.useRef(isSelected);
    React127.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
    return (0, import_jsx_runtime106.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime106.jsx)(
      Primitive32.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
function createSlot35(ownerName) {
  const SlotClone = createSlotClone35(ownerName);
  const Slot210 = React128.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React128.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable35);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React128.Children.count(newElement) > 1) return React128.Children.only(null);
          return React128.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime107.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React128.isValidElement(newElement) ? React128.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime107.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
var Slot39 = createSlot35("Slot");
function createSlotClone35(ownerName) {
  const SlotClone = React128.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React128.isValidElement(children)) {
      const childrenRef = getElementRef36(children);
      const props2 = mergeProps35(slotProps, children.props);
      if (children.type !== React128.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React128.cloneElement(children, props2);
    }
    return React128.Children.count(children) > 1 ? React128.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER35 = Symbol("radix.slottable");
function createSlottable35(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime107.jsx)(import_jsx_runtime107.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER35;
  return Slottable210;
}
var Slottable36 = createSlottable35("Slottable");
function isSlottable35(child) {
  return React128.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER35;
}
function mergeProps35(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef36(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive33 = NODES33.reduce((primitive, node) => {
  const Slot44 = createSlot35(`Primitive.${node}`);
  const Node2 = React129.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime108.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var ToastProvider = (props) => {
  ...
  const [viewport, setViewport] = React130.useState(null);
  const [toastCount, setToastCount] = React130.useState(0);
  const isFocusedToastEscapeKeyDownRef = React130.useRef(false);
  const isClosePausedRef = React130.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime109.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime109.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React130.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React130.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React130.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const wrapperRef = React130.useRef(null);
    const headFocusProxyRef = React130.useRef(null);
    const tailFocusProxyRef = React130.useRef(null);
    ...
    const getSortedTabbableCandidates = React130.useCallback(
      ({ tabbingDirection }) => {
    ...
    return (0, import_jsx_runtime109.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime109.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime109.jsx)(Collection9.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime109.jsx)(Primitive33.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime109.jsx)(
            FocusProxy,
            {
...
var FocusProxy = React130.forwardRef(
  (props, forwardedRef) => {
...
var Toast = React130.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime109.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime109.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React130.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React130.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React130.useRef(null);
    const swipeDeltaRef = React130.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React130.useRef(0);
    const closeTimerRemainingTimeRef = React130.useRef(duration);
    const closeTimerRef = React130.useRef(0);
    ...
    const startTimer = React130.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React130.useMemo(() => {
      return node ? getAnnounceTextContent(node) : null;
    }, [node]);
    if (!context.viewport) return null;
    return (0, import_jsx_runtime109.jsxs)(import_jsx_runtime109.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime109.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime109.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM38.createPortal(
        (0, import_jsx_runtime109.jsx)(Collection9.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime109.jsx)(
          Root4,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React130.useState(false);
  const [isAnnounced, setIsAnnounced] = React130.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  React130.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : (0, import_jsx_runtime109.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime109.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime109.jsxs)(import_jsx_runtime109.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React130.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return (0, import_jsx_runtime109.jsx)(Primitive33.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME3;
var DESCRIPTION_NAME3 = "ToastDescription";
var ToastDescription = React130.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return (0, import_jsx_runtime109.jsx)(Primitive33.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME3;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React130.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime109.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime109.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.displayName = ACTION_NAME2;
var CLOSE_NAME3 = "ToastClose";
var ToastClose = React130.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME3, __scopeToast);
    return (0, import_jsx_runtime109.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime109.jsx)(
      Primitive33.button,
      {
        type: "button",
        ...closeProps,
...
var ToastAnnounceExclude = React130.forwardRef((props, forwardedRef) => {
...
// ../../node_modules/@radix-ui/react-toggle/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React131 = __toESM(require_react(), 1);
var import_jsx_runtime110 = __toESM(require_jsx_runtime(), 1);
function createSlot36(ownerName) {
  const SlotClone = createSlotClone36(ownerName);
  const Slot210 = React131.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React131.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable36);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React131.Children.count(newElement) > 1) return React131.Children.only(null);
          return React131.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime110.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React131.isValidElement(newElement) ? React131.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime110.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
var Slot40 = createSlot36("Slot");
function createSlotClone36(ownerName) {
  const SlotClone = React131.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React131.isValidElement(children)) {
      const childrenRef = getElementRef37(children);
      const props2 = mergeProps36(slotProps, children.props);
      if (children.type !== React131.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React131.cloneElement(children, props2);
    }
    return React131.Children.count(children) > 1 ? React131.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER36 = Symbol("radix.slottable");
function createSlottable36(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime110.jsx)(import_jsx_runtime110.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER36;
  return Slottable210;
}
var Slottable37 = createSlottable36("Slottable");
function isSlottable36(child) {
  return React131.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER36;
}
function mergeProps36(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef37(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive34 = NODES34.reduce((primitive, node) => {
  const Slot44 = createSlot36(`Primitive.${node}`);
  const Node2 = React132.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime111.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var NAME8 = "Toggle";
var Toggle = React133.forwardRef((props, forwardedRef) => {
...
// ../../node_modules/@radix-ui/react-toggle-group/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React134 = __toESM(require_react(), 1);
var import_jsx_runtime113 = __toESM(require_jsx_runtime(), 1);
function createSlot37(ownerName) {
  const SlotClone = createSlotClone37(ownerName);
  const Slot210 = React134.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React134.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable37);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React134.Children.count(newElement) > 1) return React134.Children.only(null);
          return React134.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime113.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React134.isValidElement(newElement) ? React134.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime113.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
var Slot41 = createSlot37("Slot");
function createSlotClone37(ownerName) {
  const SlotClone = React134.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React134.isValidElement(children)) {
      const childrenRef = getElementRef38(children);
      const props2 = mergeProps37(slotProps, children.props);
      if (children.type !== React134.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React134.cloneElement(children, props2);
    }
    return React134.Children.count(children) > 1 ? React134.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER37 = Symbol("radix.slottable");
function createSlottable37(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime113.jsx)(import_jsx_runtime113.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER37;
  return Slottable210;
}
var Slottable38 = createSlottable37("Slottable");
function isSlottable37(child) {
  return React134.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER37;
}
function mergeProps37(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef38(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive35 = NODES35.reduce((primitive, node) => {
  const Slot44 = createSlot37(`Primitive.${node}`);
  const Node2 = React135.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime114.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var ToggleGroup = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime115.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime115.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime115.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime115.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime115.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime115.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime115.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime115.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime115.jsx)(Primitive35.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime115.jsx)(Primitive35.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime115.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime115.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime115.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
// ../../node_modules/@radix-ui/react-toolbar/node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var React137 = __toESM(require_react(), 1);
var import_jsx_runtime116 = __toESM(require_jsx_runtime(), 1);
function createSlot38(ownerName) {
  const SlotClone = createSlotClone38(ownerName);
  const Slot210 = React137.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React137.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable38);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React137.Children.count(newElement) > 1) return React137.Children.only(null);
          return React137.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime116.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React137.isValidElement(newElement) ? React137.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime116.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
var Slot42 = createSlot38("Slot");
function createSlotClone38(ownerName) {
  const SlotClone = React137.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React137.isValidElement(children)) {
      const childrenRef = getElementRef39(children);
      const props2 = mergeProps38(slotProps, children.props);
      if (children.type !== React137.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React137.cloneElement(children, props2);
    }
    return React137.Children.count(children) > 1 ? React137.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
var SLOTTABLE_IDENTIFIER38 = Symbol("radix.slottable");
function createSlottable38(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime116.jsx)(import_jsx_runtime116.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER38;
  return Slottable210;
}
var Slottable39 = createSlottable38("Slottable");
function isSlottable38(child) {
  return React137.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER38;
}
function mergeProps38(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef39(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive36 = NODES36.reduce((primitive, node) => {
  const Slot44 = createSlot38(`Primitive.${node}`);
  const Node2 = React138.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot44 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
    }
    return (0, import_jsx_runtime117.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var Toolbar = React139.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime118.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime118.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React139.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React139.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime118.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime118.jsx)(Primitive36.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React139.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime118.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime118.jsx)(
      Primitive36.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React139.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React139.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime118.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime118.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
function createSlot39(ownerName) {
  const SlotClone = createSlotClone39(ownerName);
  const Slot210 = React140.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React140.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable39);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
      ...
      return (0, import_jsx_runtime119.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React140.isValidElement(newElement) ? React140.cloneElement(newElement, void 0, newChildren) : null });
    }
    return (0, import_jsx_runtime119.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot210.displayName = `${ownerName}.Slot`;
  return Slot210;
}
var Slot43 = createSlot39("Slot");
function createSlotClone39(ownerName) {
  const SlotClone = React140.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React140.isValidElement(children)) {
      const childrenRef = getElementRef40(children);
      const props2 = mergeProps39(slotProps, children.props);
...
var SLOTTABLE_IDENTIFIER39 = Symbol("radix.slottable");
function createSlottable39(ownerName) {
  const Slottable210 = ({ children }) => {
    return (0, import_jsx_runtime119.jsx)(import_jsx_runtime119.Fragment, { children });
  };
  Slottable210.displayName = `${ownerName}.Slottable`;
  Slottable210.__radixId = SLOTTABLE_IDENTIFIER39;
  return Slottable210;
}
var Slottable40 = createSlottable39("Slottable");
function isSlottable39(child) {
  return React140.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER39;
}
function mergeProps39(slotProps, childProps) {
  const overrideProps = { ...childProps };
  for (const propName in childProps) {
    const slotPropValue = slotProps[propName];
    const childPropValue = childProps[propName];
...
function getElementRef40(element) {
  let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
  let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
  if (mayWarn) {
    return element.ref;
...
var Primitive37 = NODES37.reduce((primitive, node) => {
  const Slot44 = createSlot39(`Primitive.${node}`);
  const Node2 = React141.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime120.jsx)(Comp, { ...primitiveProps, ref: forwardedRef });
  });
  Node2.displayName = `Primitive.${node}`;
  return { ...primitive, [node]: Node2 };
}, {});
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React142.useRef(true);
  const isPointerInTransitRef = React142.useRef(false);
  const skipDelayTimerRef = React142.useRef(0);
  React142.useEffect(() => {
  ...
  return (0, import_jsx_runtime121.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React142.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React142.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React142.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React142.useState(null);
  const contentId = useId();
  const openTimerRef = React142.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React142.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React142.useMemo(() => {
    return open ? wasOpenDelayedRef.current ? "delayed-open" : "instant-open" : "closed";
  }, [open]);
  const handleOpen = React142.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = 0;
    wasOpenDelayedRef.current = false;
    setOpen(true);
  }, [setOpen]);
  const handleClose = React142.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = 0;
    setOpen(false);
  }, [setOpen]);
  const handleDelayedOpen = React142.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = window.setTimeout(() => {
  ...
  return (0, import_jsx_runtime121.jsx)(Root24, { ...popperScope, children: (0, import_jsx_runtime121.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React142.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React142.useCallback(() => {
...
var TooltipTrigger = React142.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React142.useRef(false);
    const hasPointerMoveOpenedRef = React142.useRef(false);
    const handlePointerUp = React142.useCallback(() => isPointerDownRef.current = false, []);
    React142.useEffect(() => {
      return () => document.removeEventListener("pointerup", handlePointerUp);
    }, [handlePointerUp]);
    return (0, import_jsx_runtime121.jsx)(Anchor, { asChild: true, ...popperScope, children: (0, import_jsx_runtime121.jsx)(
      Primitive37.button,
      {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime121.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime121.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime121.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME11;
var CONTENT_NAME15 = "TooltipContent";
var TooltipContent = React142.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime121.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime121.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime121.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React142.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React142.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React142.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React142.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React142.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime121.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable41 = createSlottable39("TooltipContent");
var TooltipContentImpl = React142.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
    ...
    return (0, import_jsx_runtime121.jsx)(
      DismissableLayer,
      {
        ...
        onFocusOutside: (event) => event.preventDefault(),
        onDismiss: onClose,
        children: (0, import_jsx_runtime121.jsxs)(
          Content4,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              (0, import_jsx_runtime121.jsx)(Slottable41, { children }),
              (0, import_jsx_runtime121.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime121.jsx)(Root, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React142.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime121.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
